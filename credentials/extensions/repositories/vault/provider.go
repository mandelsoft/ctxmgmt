...
func (p *ConsumerProvider) read(ctx context.Context, client *vault.Client, secret string) (utils.Properties, utils.Properties, []string, error) {
	// read the secret
...
func getProps(data map[string]interface{}) utils.Properties {
