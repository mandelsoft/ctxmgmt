...
type ActionHandler interface {
	Handle(api.ActionSpec, utils.Properties) (api.ActionResult, error)
}
...
type Registry interface {
	...
	Execute(spec api.ActionSpec, creds utils.Properties) (api.ActionResult, error)
...
func (r *registry) Execute(spec api.ActionSpec, creds utils.Properties) (api.ActionResult, error) {
	result := r.Get(spec)
